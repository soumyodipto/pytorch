...
def get_supported_pattern_dtype_config(
    pattern: Pattern,
    ...
    for node in nodes_before_observation:
        ...
        if node.op == 'placeholder':
            ...
            if pattern is not None and matched_node_pattern is not None and backend_config is not None:
                supported_dtype_config = get_supported_pattern_dtype_config(
            ...
            if qconfig is not None and supported_dtype_config is not None:
                ...
                #   (1) The qconfigs that were previously already attached to the corresponding modules
